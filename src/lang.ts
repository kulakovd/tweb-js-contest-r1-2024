const lang = {
  ...
  'LiveStream.Bar.TapToJoin': 'Tap to join',
  ...
  'LiveStream.PopUp.Stream.URLCopied': 'URL copied to clipboard',
  'LiveStream.PopUp.Stream.KeyCopied': 'Key copied to clipboard',
